            ...
            <main className="flex-1 flex items-center justify-center px-6 py-10">
                <div className="w-full max-w-3xl">
                    <div className="border rounded-2xl p-10 shadow-sm text-center bg-white">
                        <h1 className="text-5xl font-bold text-zinc-900">P2P Share</h1>
                        ...
                        <div className="grid md:grid-cols-3 gap-4 mt-10">
                            <div className="border rounded-xl p-4">
                                <h3 className="font-semibold text-zinc-900">Direct P2P</h3>
                            ...
                            <div className="border rounded-xl p-4">
                                <h3 className="font-semibold text-zinc-900">Encrypted</h3>
                            ...
                            <div className="border rounded-xl p-4">
                                <h3 className="font-semibold text-zinc-900">Verified</h3>
